...
INSERT INTO `bicing`.`bicicleta_has_estacion` (`bicicleta_id_bicicleta`, `estacion_id_estacion`) VALUES (1, 7);
INSERT INTO `bicing`.`bicicleta_has_estacion` (`bicicleta_id_bicicleta`, `estacion_id_estacion`) VALUES (2, 7);
INSERT INTO `bicing`.`bicicleta_has_estacion` (`bicicleta_id_bicicleta`, `estacion_id_estacion`) VALUES (3, 5);
INSERT INTO `bicing`.`bicicleta_has_estacion` (`bicicleta_id_bicicleta`, `estacion_id_estacion`) VALUES (4, 2);
INSERT INTO `bicing`.`bicicleta_has_estacion` (`bicicleta_id_bicicleta`, `estacion_id_estacion`) VALUES (5, 1);
INSERT INTO `bicing`.`bicicleta_has_estacion` (`bicicleta_id_bicicleta`, `estacion_id_estacion`) VALUES (6, 2);
INSERT INTO `bicing`.`bicicleta_has_estacion` (`bicicleta_id_bicicleta`, `estacion_id_estacion`) VALUES (7, 4);
INSERT INTO `bicing`.`bicicleta_has_estacion` (`bicicleta_id_bicicleta`, `estacion_id_estacion`) VALUES (8, 2);
INSERT INTO `bicing`.`bicicleta_has_estacion` (`bicicleta_id_bicicleta`, `estacion_id_estacion`) VALUES (9, 3);
INSERT INTO `bicing`.`bicicleta_has_estacion` (`bicicleta_id_bicicleta`, `estacion_id_estacion`) VALUES (10, 1);

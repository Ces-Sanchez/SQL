use bicing;
drop procedure if exists deja_bici;

create procedure deja_bici(in id_bici int, in numero_estacion INT)
begin

UPDATE incidencias set estado = 'reparada' where bicicleta_id_bicicleta = id_bici;
INSERT into bicicleta_has_estacion values (id_bici,numero_estacion);

...
`id_bicicleta`, `fecha_de_alta`, `estado_bicicleta`, `tipo_bicicleta`, `en_uso_o_parada`, `reservada_o_disponible`, `estacion_id_estacion`) 
VALUES (DEFAULT, DEFAULT, 'funcionando', 'mecánica', 'parada', 'disponible', 1);
INSERT INTO `bicing`.`bicicleta` (
`id_bicicleta`, `fecha_de_alta`, `estado_bicicleta`, `tipo_bicicleta`, `en_uso_o_parada`, `reservada_o_disponible`, `estacion_id_estacion`) 
VALUES (DEFAULT, DEFAULT, 'funcionando', 'mecánica', 'parada', 'disponible', 4);
INSERT INTO `bicing`.`bicicleta` (
`id_bicicleta`, `fecha_de_alta`, `estado_bicicleta`, `tipo_bicicleta`, `en_uso_o_parada`, `reservada_o_disponible`, `estacion_id_estacion`) 
VALUES (DEFAULT, DEFAULT, 'funcionando', 'mecánica', 'parada', 'disponible', 7);
INSERT INTO `bicing`.`bicicleta` (
`id_bicicleta`, `fecha_de_alta`, `estado_bicicleta`, `tipo_bicicleta`, `en_uso_o_parada`, `reservada_o_disponible`, `estacion_id_estacion`) 
VALUES (DEFAULT, DEFAULT, 'funcionando', 'mecánica', 'parada', 'disponible', 3);
INSERT INTO `bicing`.`bicicleta` (
`id_bicicleta`, `fecha_de_alta`, `estado_bicicleta`, `tipo_bicicleta`, `en_uso_o_parada`, `reservada_o_disponible`, `estacion_id_estacion`) 
VALUES (DEFAULT, DEFAULT, 'funcionando', 'mecánica', 'parada', 'disponible', 1);
INSERT INTO `bicing`.`bicicleta` (
`id_bicicleta`, `fecha_de_alta`, `estado_bicicleta`, `tipo_bicicleta`, `en_uso_o_parada`, `reservada_o_disponible`, `estacion_id_estacion`) 
VALUES (DEFAULT, DEFAULT, 'funcionando', 'mecánica', 'parada', 'disponible', 2);
INSERT INTO `bicing`.`bicicleta` (
`id_bicicleta`, `fecha_de_alta`, `estado_bicicleta`, `tipo_bicicleta`, `en_uso_o_parada`, `reservada_o_disponible`, `estacion_id_estacion`) 
VALUES (DEFAULT, DEFAULT, 'funcionando', 'mecánica', 'parada', 'disponible', 2);
INSERT INTO `bicing`.`bicicleta` (
...
-- INSERT INTO `bicing`.`servicio` (`usuario_id_usuario`, `bicicleta_id_bicicleta`, `usuario_id_tarifa`, `servicio_finalizado`) VALUES (3, 3, 1, 0);
-- INSERT INTO `bicing`.`servicio` (`usuario_id_usuario`, `bicicleta_id_bicicleta`, `usuario_id_tarifa`, `servicio_finalizado`) VALUES (6, 7, 2, 0);
-- INSERT INTO `bicing`.`servicio` (`usuario_id_usuario`, `bicicleta_id_bicicleta`, `usuario_id_tarifa`, `servicio_finalizado`) VALUES (4, 2, 1, 0);
-- INSERT INTO `bicing`.`servicio` (`usuario_id_usuario`, `bicicleta_id_bicicleta`, `usuario_id_tarifa`, `servicio_finalizado`) VALUES (2, 6, 3, 0);
-- INSERT INTO `bicing`.`servicio` (`usuario_id_usuario`, `bicicleta_id_bicicleta`, `usuario_id_tarifa`, `servicio_finalizado`) VALUES (1, 2, 4, 0);
-- INSERT INTO `bicing`.`servicio` (`usuario_id_usuario`, `bicicleta_id_bicicleta`, `usuario_id_tarifa`, `servicio_finalizado`) VALUES (2, 5, 2, 0);
COMMIT;
